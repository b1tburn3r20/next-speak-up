...
interface NoUserLoginButtonProps {
  missing?: string;
  message?: string;
}

const NoUserLoginButton = ({
  missing = "Login",
  message = "Sign in to view",
}: NoUserLoginButtonProps) => {
  const setOpen = useLoginStore((f) => f.setIsLoginDialogOpen);
...
export default NoUserLoginButton;
