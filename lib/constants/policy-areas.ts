...
export const PolicyAreas: Record<PolicyAreaKey, PolicyAreaDescription> = {
  "Agriculture and Food": {
    ...
    chart_color_light: "#4ADE80",
    chart_color_dark: "#166534",
  },
  ...
  Animals: {
    ...
    chart_color_light: "#FB923C",
    chart_color_dark: "#9A3412",
  },
  "Armed Forces and National Security": {
    ...
    chart_color_light: "#60A5FA",
    chart_color_dark: "#1E3A8A",
  },
  ...
  "Arts, Culture, Religion": {
    ...
    chart_color_light: "#C084FC",
    chart_color_dark: "#581C87",
  },
  "Civil Rights and Liberties, Minority Issues": {
    ...
    chart_color_light: "#F472B6",
    chart_color_dark: "#831843",
  },
  Commerce: {
    official:
    ...
    chart_color_light: "#2DD4BF",
    chart_color_dark: "#134E4A",
  },
  Congress: {
    official:
    ...
    chart_color_light: "#94A3B8",
    chart_color_dark: "#1E293B",
  },
  ...
  "Crime and Law Enforcement": {
    ...
    chart_color_light: "#EF4444",
    chart_color_dark: "#7F1D1D",
  },
  "Economics and Public Finance": {
    ...
    chart_color_light: "#22C55E",
    chart_color_dark: "#14532D",
  },
  Education: {
    official:
  ...
  "Emergency Management": {
    ...
    chart_color_light: "#F97316",
    chart_color_dark: "#7C2D12",
  },
  Energy: {
    official:
    ...
    chart_color_light: "#FACC15",
    chart_color_dark: "#713F12",
  },
  "Environmental Protection": {
    ...
    chart_color_light: "#10B981",
    chart_color_dark: "#064E3B",
  },
  Families: {
    official:
  ...
  "Finance and Financial Sector": {
    ...
    chart_color_light: "#06B6D4",
    chart_color_dark: "#164E63",
  },
  "Foreign Trade and International Finance": {
    ...
    chart_color_light: "#6366F1",
    chart_color_dark: "#312E81",
  },
  ...
  Health: {
    ...
    chart_color_light: "#F87171",
    chart_color_dark: "#991B1B",
  },
  ...
  "International Affairs": {
    ...
    chart_color_light: "#818CF8",
    chart_color_dark: "#3730A3",
  },
  ...
  Law: {
    ...
    chart_color_light: "#A78BFA",
    chart_color_dark: "#4C1D95",
  },
  "Native Americans": {
    official:
  ...
  "Social Sciences and History": {
    ...
    chart_color_light: "#FB7185",
    chart_color_dark: "#881337",
  },
  "Social Welfare": {
    official:
    ...
    chart_color_light: "#38BDF8",
    chart_color_dark: "#075985",
  },
  ...
  Uncategorized: {
    ...
    chart_color_light: "#D1D5DB",
    chart_color_dark: "#374151",
  },
  Unknown: {
    official: "The government did not properly keep track of this information.",
    ai_summarized:
